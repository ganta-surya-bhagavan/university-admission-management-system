...
public class PlpCourseServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(PlpCourseServiceApplication.class, args);
	}
	@LoadBalanced 
	@Bean
...
private ApiInfo myApiInfo() {
		...
		return new ApiInfo(
			"SPRING WITH SWAGGER API", 
		     ...
		     "1.0", 
		     "Free to Use", 
		     new Contact("Surya Bhagavan","/api" ,"suryabhagavan48048@gmail.com"),
		     "API licence",
		     "/api",
